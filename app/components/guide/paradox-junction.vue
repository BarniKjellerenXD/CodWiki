<!-- AUTO-GENERATED by scripts/convert-guides.mjs from public/guides/paradox-junction.html -->
<template>
...
<h1 id="wiki_paradox_junction_.7C_complete_map_breakdown">Paradox Junction | Complete Map Breakdown</h1>
...
<p style="text-align: center;"><strong><img alt="" class="wiki-img-none wiki-img-no-wrap wiki-img-in-table" data-height="2160" data-media-id="worp5qbwigrg1" data-width="3840" height="1080" width="1920" src="https://preview.redd.it/worp5qbwigrg1.jpeg?width=1920&amp;height=1080&amp;format=pjpg&amp;auto=webp&amp;s=80c09580c2dca7e3df0e706863bdb5420769a891"></strong></p>
<p style="text-align: center;"><em><strong>Killing time was never this much fun! Play gruesome games with the creepy Twins, destroy the Dark Heart and escape the warden's temporal prison!</strong></em></p>
<hr>
...
<div class="glass-card glass-gold"><h2 id="wiki_blundergat"><label class="g-toggle"><input type="checkbox" class="g-cb" checked><span class="g-title">Blundergat<span class="g-tag">🔫 Wonder Weapon</span></span><span class="g-chev" aria-hidden="true"></span></label></h2>
<ol>
<li>Get 4 parts:
<ul>
...
<div class="cheat-grid">
  <div class="cheat-block phase1">
    <h2>① Setup</h2>
    <ol>
      <li>Obtain the <strong>Blundergat</strong> and upgrade to the <strong>Sundergat</strong>.</li>
      <li><strong>The Twins Swing:</strong> swing seat (Normal, Yellow House) → RC-XD race (Destroyed) → Chalk → rehang swing → Twins scene.</li>
    </ol>
    <p class="cheat-note">The next three sections can be done in any order / simultaneously.</p>
  </div>
  <div class="cheat-block phase2">
    <h2>② Strange Tree / Hopscotch</h2>
    <ol>
      <li>Irradiated Seeds (Destroyed garage toolbox) → plant in Normal Trinity Ave mound → fill tree with souls (Blundergat/Sundergat).</li>
      <li>3 Combat Axes → Strange Firewood → fireplace (Molotov).</li>
      <li>Stand on the massive X in Destroyed Trinity Ave until it stays blue → Normal: hopscotch scene → jump 1→12→1 (avoid smoke, 30s fail wait).</li>
      <li>Golden music box spawns → fill with souls (Sundergat) → escort to fireplace.</li>
    </ol>
  </div>
  <div class="cheat-block phase2">
    <h2>③ Piano / Bouncing Ball</h2>
    <ol>
      <li>Destroyed Green House: turn <strong>Piano Teacher</strong> (Brain Rot/Psych) → teleport back → it plays piano &amp; explodes.</li>
      <li>8 glowing notes in Destroyed — blink order 1–8 → interact in order → piano order on wall is always <strong>86756535</strong>.</li>
      <li>Kill 3 floating zombies → souls over the X → Normal: ball trial — kill airborne zombies before ball lands → music sheet → escort to piano (Sundergat).</li>
    </ol>
  </div>
  <div class="cheat-block phase2">
    <h2>④ Toy Box / Four Square</h2>
    <ol>
      <li>Destroyed PaP area: shoot speaker pole → Goggles (use Wisp Tea to bring in).</li>
      <li>Death Perception: find Headset outline → Normal toy box scene.</li>
      <li>Red ball → shoot to the massive X in Destroyed Green House Backyard → Four Square trial — bounce ball square-to-square until timer ends.</li>
      <li>Cymbals spawn → fill with souls (Sundergat) → escort to toy box.</li>
    </ol>
  </div>
  <div class="cheat-block phase3">
    <h2>⑤ Clock Tower</h2>
    <ol>
      <li>Destroyed: shoot crumbled clock → hands to 0.</li>
      <li>Teleport to Normal; <strong>shoot the hands again during the teleport animation</strong>.</li>
      <li>White orb appears → scene: piano → toy box → fireplace → Twins at the swing with a <strong>yellow portal</strong> → boss fight.</li>
    </ol>
  </div>
  <div class="cheat-block phase4">
    <h2>⑥ Dark Heart Boss</h2>
    <ol>
      <li><strong>P1:</strong> 3 goo piles (Trinity/Yellow/Green House) → fill cysts with souls → clear goo → defend Concentration Field on each revealed object → damage orange spots; redirect tornadoes with Molotovs.</li>
      <li><strong>P2:</strong> Rad-Hounds spawn; kill from green orbs to clear goo → defend fields again → ⅔ health.</li>
      <li><strong>P3:</strong> Shock Mimics; bring Tortured Zombie to each object &amp; kill to clear goo → defend → finish the Heart.</li>
    </ol>
  </div>
</div>
...
<div class="glass-card glass-gold"><h2 class="" id="wiki_115_clock_.28free_loot.29"><label class="g-toggle"><input type="checkbox" class="g-cb"><span class="g-title">115 Clock (Free loot)<span class="g-tag">🕐 115 Clock</span></span><span class="g-chev" aria-hidden="true"></span></label></h2>
<ol>
<li>In Destroyed Nuketown, shoot the clock hands to display 1:15 as it would be on a standard clock.</li>
<li>Travel to Normal Nuketown and loot will spawn at the back of Cul-De-Sac. The rewards are:
<ul>
<li>A Legendary Weapon, a Killstreak, a Rare Aether Tool (Blue), a Raw Aether Crystal (PaP 1), a Perk can.</li>
</ul>
</li>
</ol></div>
...
<li><strong>After Round 15</strong> - Flawless Aetherium Crystal (PaP 3), Speed Cola can, 2000 Salvage</li>
</ol>
</li>
</ol></div>
...
<p>There are 3 Relics that can be unlocked from playing Paradox Junction, those Relics are then used as gameplay modifiers for Cursed mode.</p>
  ...
  <div class="relic-section">
    ...
    <div class="relic-cards">
      <div class="relic-card grim">
        <div class="relic-title">ROCKET <span class="mini-tag">No Score Streaks</span></div>
        <ol class="steps">
  ...
  <div class="relic-section">
    ...
    <div class="relic-cards">
      <div class="relic-card wicked">
        <div class="relic-title">MANGLER HELMET <span class="mini-tag">No Arsenal</span></div>
        <ol class="steps">
